...
function keydown(e) {
    ...
    else if (event.keyCode == 87) { //w -- avance en L del brazo
        return message("w", -1);
    ...
    else if (event.keyCode == 81) { //q -- avance en Z con el brazo
        return message("q", -1);
    ...
    else if (event.keyCode == 77) { //m -- inclinacion de la camara
        return message("m", -1);
    ...
    else if (event.keyCode == 65) { //a -- rotar el brazo theta1
        return message("a", -1);
    ...
    else if (event.keyCode == 73) { //i -- camara apunta hacia arriva
        return message("i", -1);
    ...
    else if (event.keyCode == 74) { //j --camara apunta hacia la izquierda
        return message("j", -1);
...
window.onload = function () { // En caso el navegador no pueda grabar el streaming
...
window.onbeforeunload = function () { // Detiene la comunicación antes de cerrar la pagina
    if (ws) {
